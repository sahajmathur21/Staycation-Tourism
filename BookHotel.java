...
public class BookHotel extends JFrame implements ActionListener{
    ...
    BookHotel(String username){
       ...
       labelprice = new JLabel();
        ...
        imageLabel.setBounds(500, 50, 600, 400);
        add(imageLabel);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()== checkprice){
            ...
            try{
                Conn c = new Conn();
                c.s.executeUpdate("insert into bookhotel values ('"+labelusername.getText()+"','"+chotel.getSelectedItem()+"','"+tfpersons.getText()+"','"+tfdays.getText()+"','"+cac.getSelectedItem()+"','"+labelid.getText()+"','"+cfood.getSelectedItem()+"','"+labelnumber.getText()+"','"+labelphone.getText()+"','"+labelprice.getText()+"')");
